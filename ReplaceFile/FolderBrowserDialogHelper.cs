...
{
    /// <summary>
    /// 一个用来修复FolderBrowserDialog弹出后，无法正常显示所选择项的问题。
    /// 详细见 https://haolaoshi.blog.csdn.net/article/details/91350783
    /// </summary>
        ...
        public static DialogResult ShowFolderBrowser(FolderBrowserDialog dlg, IWin32Window parent = null)
        {
            ...
            using (Timer t = new Timer())
            {
                t.Tick += (s, a) =>
                {
                    ...
                    {
                        //
                        //  In case we failed to find the Tree View control, 
                        //  We will send some fake keystrokes to the application in an attempt to force
                        //  the Tree View to scroll to the selected item as a fall back (and this is an UberUgly hack).
                        //
                        t.Stop();
